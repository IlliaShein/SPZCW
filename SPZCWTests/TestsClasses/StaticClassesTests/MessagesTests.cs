...
namespace SPZCWTests
{
    ...
    public class MessagesTests
    {
        ...
        public void TestServiceTypesHelpReturnsCorrrectValue()
        {
            ...
            string kernelDriver = "[mediumturquoise]Kernel Driver[/]: these are services that run in the context of the operating system " +
            ...
            string fileSystemDriver = "[mediumturquoise]File System Driver[/]: these are services that provide access to file systems and" +
            ...
            string adapter = "[mediumturquoise]Adapter[/]: these are services that provide access to network adapters and manage " +
            ...
            string interractiveProcess = "[mediumturquoise]Interactive Process[/]: these are services designed to interact with the user through" +
                " a graphical interface. Examples include services for managing the display or services for managing" +
                " user notifications.\n\n\r";
            string recognizedDriver = "[mediumturquoise]Recognizer Driver[/]: these are services that provide" +
            ...
            string win32OwnProcess = "[mediumturquoise]Win32 Own Process[/]: these are services that run in their own process and do not share" +
            ...
            string win32ShareProcess = "[mediumturquoise]Win32 Share Process[/]: these are services that run in a shared process with" +
        ...
        public void TestServiceNamesHelpReturnsCorrrectValue()
        {
            ...
            string displayName = "[mediumturquoise]DisplayName[/]: The display name is the name that is shown to users in the Windows" +
            ...
            string serviceName = "[mediumturquoise]ServiceName[/]: The service name is the name used to identify the service internally in" +
                " Windows. This name is used by the operating system to start and stop the service," +
                " as well as to monitor its status.\n\n\r";
            string machineName = "[mediumturquoise]MachineName[/]: This name is used to specify the name of the machine on which" +
        ...
        public void TestServiceStatusHelpReturnsCorrrectValue()
        {
            ...
            string stopped = "[mediumturquoise]Stopped[/]: This value indicates that the service is not running. " +
                "This means that the service is not currently executing any tasks or performing any operations.\n\n\r";
            string startPending = "[mediumturquoise]StartPending[/]: This value indicates that the service has been requested to start, but" +
                " it is not yet running. This means that the service is currently in the process of starting up.\n\n\r";
            string StopPending = "[mediumturquoise]StopPending[/]: This value indicates that the service has been requested to stop," +
                " but it is not yet stopped. This means that the service is currently in the process" +
                " of shutting down.\n\n\r";
            string running = "[mediumturquoise]Running[/]: This value indicates that the service is currently running. " +
                "This means that the service is currently executing tasks or performing operations.\n\n\r";
            string continuePending = "[mediumturquoise]ContinuePending[/]: This value indicates that the service has been requested" +
            ...
            string pausePending = "[mediumturquoise]PausePending[/]: This value indicates that the service has been requested" +
                " to pause, but it is not yet paused. This means that the service is currently in the process" +
                " of being paused.\n\n\r";
            string paused = "[mediumturquoise]Paused[/]: This value indicates that the service is currently paused. This means that" +
        ...
        public void TestServiceStartTypesHelpReturnsCorrrectValue()
        {
            ...
            string introduction = "[bold]In Windows operating systems, a service is a program that runs in the background and" +
                ...
                "types in Windows:[/]\n\n\r";
            string automatic = "[mediumturquoise]Automatic[/]: This is the default start type for most Windows services. " +
            ...
            string manual = "[mediumturquoise]Manual[/]: Services set to this start type do not start automatically when the operating " +
            ...
            string disabled = "[mediumturquoise]Disabled[/]: Services set to this start type are not started at all, even if they " +
            ...
            string boot = "[mediumturquoise]Boot[/]: Services set to this start type are started during the boot process, before any" +
                " user logs in. This type of service is only used by system services and is not available for " +
                "user-defined services.\n\n\r";
            string system = "[mediumturquoise]System[/]: This start type is used only by kernel-mode device drivers and services that" +
